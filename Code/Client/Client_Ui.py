...
"")
        ...
        self.Btn_Tracking_Balls.setGeometry(QtCore.QRect(230, 560, 90, 30))
        font = QtGui.QFont()
        font.setFamily("3ds")
        font.setPointSize(10)
        ...
        self.Btn_Mode6 = QtWidgets.QRadioButton(Client)
        self.Btn_Mode6.setGeometry(QtCore.QRect(335, 660, 90, 30))
        font = QtGui.QFont()
        font.setFamily("3ds")
        font.setPointSize(10)
        self.Btn_Mode6.setFont(font)
        self.Btn_Mode6.setObjectName("Btn_Mode6")
        self.Btn_Tracking_Bottle = QtWidgets.QPushButton(Client)
        self.Btn_Tracking_Bottle.setGeometry(QtCore.QRect(230, 610, 90, 30))
        font = QtGui.QFont()
        font.setFamily("3ds")
        font.setPointSize(10)
        ...
        self.Btn_Avoiding_Line = QtWidgets.QRadioButton(Client)
        self.Btn_Avoiding_Line.setGeometry(QtCore.QRect(600, 610, 90, 30))
        font = QtGui.QFont()
        font.setFamily("3ds")
        font.setPointSize(10)
        self.Btn_Avoiding_Line.setFont(font)
        self.Btn_Avoiding_Line.setObjectName("Btn_Mode5")
    ...
    def retranslateUi(self, Client):
        ...
        self.Btn_Mode5.setText(_translate("Client", "M-Avoid"))
        self.Btn_Mode6.setText(_translate("Client", "M-Find"))
        self.Btn_Tracking_Faces.setText(_translate("Client", "Find Face"))
        self.Btn_Tracking_Balls.setText(_translate("Client", "Find Ball"))
